...
[NBA Player Stats Explorer](https://jcohensolal.shinyapps.io/NBAStatsExplorer/)
...
Filtering is done via the use of three sliders, one checkbox group, and one drop-down menu. The sliders let you define a range for the following filters :
